...
this Application By itself is Demonstrational, It isn't used for real-world Interaction, but it behaves as Recipe Lookup Application, it is not intended for anything Enterprise, it was built like this on first place.**
              <p align="center">
                  ...
                  <b><br/>
                  <b>**Kudos to Heghine for Armenian translation**: https://github.com/ZeroaNinea</br>
...
<img width="803" height="487" alt="image" src="https://github.com/IosebiGames/RecipeDeck/blob/main/RecipeDeck/images/app_light.png?raw=true" />
  ...
  In October of 2025, I was joined in one of the Java "Help Group" where people could ask for their Help and get answers from Helpers related to Java.
   ...
   They replied on November 9th of 2025, and said that what I've done is sufficient and that it would be perfect if I hand-over the app, I agreed. However, I wanted to discuss details (like how'd we do hand-over), but after the last message of mine, they have not replied at all, its been 300+ days.<br>
     Timelines:<br>
