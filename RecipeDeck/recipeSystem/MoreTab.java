...
public class MoreTab {
	...
	public void openMoreTab() {
		...
		if(Language.currentLanguage.equals("Armenian")) {
			l.createLabel(labelList.get(0), createFont("Verdana", Font.BOLD, 15), Color.black, new Bounds(123, -19, 281, 63).getBounds(), false, null);
		}else {
			l.createLabel(labelList.get(0), createFont("Inter", Font.BOLD, 15), Color.black, new Bounds(28, -19, 281, 63).getBounds(), false, null);
		}
		if(Language.currentLanguage.equals("Armenian")) {
			l.createLabel(labelList.get(1), createFont("Verdana", Font.BOLD, 15), Color.black, new Bounds(10, 51, 288, 51).getBounds(), false, PanelList.get(0));
			l.createLabel(labelList.get(2), createFont("Verdana", Font.BOLD, 15), Color.black, new Bounds(10, 73, 277, 51).getBounds(), false, PanelList.get(0));
			l.createLabel(labelList.get(3), createFont("Verdana", Font.BOLD, 15), Color.black, new Bounds(10, 136, 215, 41).getBounds(), false, PanelList.get(0));
			l.createLabel(labelList.get(4), createFont("Verdana", Font.BOLD, 15), Color.black, new Bounds(10, 96, 265, 41).getBounds(), false, PanelList.get(0));
			l.createLabel(labelList.get(5), createFont("Verdana", Font.BOLD, 15), Color.black, new Bounds(10, 116, 265, 41).getBounds(), false, PanelList.get(0));
			l.createLabel(labelList.get(6), createFont("Verdana", Font.BOLD, 15), Color.black, new Bounds(10, 156, 275, 41).getBounds(), false, PanelList.get(0));
			l.createLabel(labelList.get(7), createFont("Verdana", Font.BOLD, 15), Color.black, new Bounds(10, 176, 275, 41).getBounds(), false, PanelList.get(0));
			l.createLabel(labelList.get(8), createFont("Verdana", Font.BOLD, 13), Color.black, new Bounds(12, 23, 380, 41).getBounds(), false, PanelList.get(0));
		}else {
		...
		if(Language.currentLanguage.equals("English")) {
			...
			productBox.setFont(createFont("Verdana", Font.BOLD, 14));
		}
		if(Language.currentLanguage.equals("Armenian")) {
